...
$LANG->includeLLFile('EXT:aware/mod1/locallang.xml');
...
/**
 * Module 'Messages' for the 'aware' extension.
 *
 * @author	Morten Tranberg Hansen <mth@cs.au.dk>
 * @package	TYPO3
 * @subpackage	tx_aware
 */
class  tx_aware_module1 extends t3lib_SCbase {
				var $pageinfo;
				...
				protected function newMessageContent() {
					...
					tx_jslang::addLL($this->doc, 'EXT:aware/mod1/locallang.xml');					
					$this->doc->loadJavascriptLib(t3lib_extMgm::extRelPath('aware').'mod1/event-grid.js');

					$result .= '<div id="event-grid"></div>';					
...
if (defined('TYPO3_MODE') && isset($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/aware/mod1/index.php']))	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/aware/mod1/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_aware_module1');
$SOBE->init();
